...
<html lang="en">
  <head>
    ...
    ?>
    <meta name="author" content="Márcio Passos|SECOM-PA">
    <link rel="icon" href="<?php echo base_url(); ?>/assets/favicon.ico">

    <title>Inscrições PSS - SECOM</title>
    <?php // echo $meta[0]['content']; ?>

    <?php 
    // $uris = array("projetos", "tarefas", "tarefa", "admin");
    // if ( in_array($this->uri->segment(1), $uris) ) {
